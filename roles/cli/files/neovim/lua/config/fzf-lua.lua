...
vim.keymap.set('n', '<Leader>g',        function() return require('fzf-lua').live_grep() end,                                           { silent = true })
vim.keymap.set('n', '<Leader>gw',       function() return require('fzf-lua').grep_cword() end,                                          { silent = true })
